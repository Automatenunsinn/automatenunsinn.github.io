...
describe('calculateScore', () => {
    ...
    it('should calculate score for horizontal matches', () => {
        ...
        expect(slotMachine.calculateScore(symbolsMatrix)).toBe(10 + 20 + 50);
    });
    ...
    it('should calculate score for anti-diagonal matches', () => {
        ...
        expect(slotMachine.calculateScore(symbolsMatrix)).toBe(60); // 60 for Banana
    });

    it('should calculate duplicate scores for overlapping matches 1', () => {
        const symbolsMatrix: string[][] = [
            ['🍒', '🍋', '🍉'],
            ['🍓', '🍒', '🍉'],
            ['🍒', '🍒', '🍒']
    ...
    it('should calculate duplicate scores for overlapping matches 2', () => {
        const symbolsMatrix: string[][] = [
            ['🍒', '🍒', '🍒'],
            ['🍉', '🍒', '🍋'],
            ['🍒', '🍓', '🍉']
